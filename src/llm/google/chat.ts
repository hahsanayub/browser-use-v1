import { GoogleGenerativeAI, type GenerateContentRequest, type Tool } from '@google/genai';
    ...
    async ainvoke<T>(
        ...
        if (output_format && 'schema' in output_format && output_format.schema) {
            try {
                ...
                console.warn('Failed to convert output_format to JSON schema for Google', e);
            }
        }
