...
//         {
//           step: 1,
//           action: { action: 'click', index: 1, reasoning: 'Click element' },
...
//         {
//           step: 2,
//           action: { action: 'input_text', text: 'Hello', reasoning: 'Input text' },
...
//         {
//           step: 1,
//           action: { action: 'navigate', url: 'about:blank', reasoning: 'Navigate to about:blank' },
